...
def sum_array(array)
    ...
    array = sum_array(array[0...-1]) + sum_array([array[-1]])
end
...
def reverse_string(str)
    ...
    str = reverse_string(str[-1]) + reverse_string(str[0..-2])
end
...
def flatten(data)
    ...
    current_pass = flatten(data[0])
    all_other_passes = flatten(data[1..-1])
    data = current_pass + all_other_passes
    data.compact
end